...
pub struct CreateSession200Response {
    ...
    #[serde(rename = "id")]
    pub id: String,
    /// Backend name. May not be set when in the \"open\" state.
    #[serde(rename = "backend_name", deserialize_with = "Option::deserialize")]
...
impl CreateSession200Response {
    /// Job session
    pub fn new(id: String, backend_name: Option<String>, mode: Mode) -> CreateSession200Response {
